...
#TEST CODE
thread_updater = threading.Thread(target=detected_lightning, args=[31, 11])
thread_updater.start()
...
thread_updater.start()
time.sleep(0.1)
thread_updater = threading.Thread(target=detected_lightning, args=[27, 2])
thread_updater.start()
time.sleep(0.5)
thread_updater = threading.Thread(target=detected_lightning, args=[14, 22])
thread_updater.start()
time.sleep(0.5)
thread_updater = threading.Thread(target=detected_lightning, args=[14, 31])
thread_updater.start()
time.sleep(0.2)
print("Database Dump:")
